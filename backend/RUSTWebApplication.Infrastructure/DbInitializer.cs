...
namespace RUSTWebApplication.Infrastructure
{
	public class DbInitializer : IDbInitializer
	{
		...
		public void Seed(RUSTWebApplicationContext context)
		{
			...
			Product hoodieProduct4 = context.Products.Add(new Product() { Id = 7, ProductModel = hoodieModel2, ProductStocks = null, Color = "Black", ImagePath = oversizedBlackHoodieImage, VideoPath = oversizedBlackHoodieVideo }).Entity;
			Product hoodieProduct5 = context.Products.Add(new Product() { Id = 8, ProductModel = hoodieModel2, ProductStocks = null, Color = "Yellow", ImagePath = oversizedYellowHoodieImage, VideoPath = oversizedYellowHoodieVideo }).Entity;
			...
			Product pantsProduct4 = context.Products.Add(new Product() { Id = 10, ProductModel = pantsModel2, ProductStocks = null, Color = "White", ImagePath = chinoWhitePantsImage, VideoPath = chinoWhitePantsVideo }).Entity;
			Product pantsProduct5 = context.Products.Add(new Product() { Id = 11, ProductModel = pantsModel2, ProductStocks = null, Color = "Blue", ImagePath = chinoBluePantsImage, VideoPath = chinoBluePantsVideo }).Entity;
			...
			Product hoodieProduct7 = context.Products.Add(new Product() { Id = 13, ProductModel = hoodieModel3, ProductStocks = null, Color = "Black", ImagePath = oversizedBlackHoodieImage, VideoPath = oversizedBlackHoodieVideo }).Entity;
			Product hoodieProduct8 = context.Products.Add(new Product() { Id = 14, ProductModel = hoodieModel3, ProductStocks = null, Color = "Yellow", ImagePath = oversizedYellowHoodieImage, VideoPath = oversizedYellowHoodieVideo }).Entity;
			Product hoodieProduct9 = context.Products.Add(new Product() { Id = 15, ProductModel = hoodieModel3, ProductStocks = null, Color = "Pink", ImagePath = oversizedPinkHoodieImage, VideoPath = oversizedPinkHoodieVideo }).Entity;
			Product pantsProduct7 = context.Products.Add(new Product() { Id = 16, ProductModel = pantsModel3, ProductStocks = null, Color = "White", ImagePath = chinoWhitePantsImage, VideoPath = chinoWhitePantsVideo }).Entity;
			Product pantsProduct8 = context.Products.Add(new Product() { Id = 17, ProductModel = pantsModel3, ProductStocks = null, Color = "Blue", ImagePath = chinoBluePantsImage, VideoPath = chinoBluePantsVideo }).Entity;
			Product pantsProduct9 = context.Products.Add(new Product() { Id = 18, ProductModel = pantsModel3, ProductStocks = null, Color = "Brown", ImagePath = chinoBrownPantsImage, VideoPath = chinoBrownPantsVideo }).Entity;
			...
			Product hoodieProduct13 = context.Products.Add(new Product() { Id = 25, ProductModel = hoodieModel5, ProductStocks = null, Color = "Black", ImagePath = oversizedBlackHoodieImage, VideoPath = oversizedBlackHoodieVideo }).Entity;
			Product hoodieProduct14 = context.Products.Add(new Product() { Id = 26, ProductModel = hoodieModel5, ProductStocks = null, Color = "Yellow", ImagePath = oversizedYellowHoodieImage, VideoPath = oversizedYellowHoodieVideo }).Entity;
			...
			Product pantsProduct13 = context.Products.Add(new Product() { Id = 28, ProductModel = pantsModel5, ProductStocks = null, Color = "White", ImagePath = chinoWhitePantsImage, VideoPath = chinoWhitePantsVideo }).Entity;
			Product pantsProduct14 = context.Products.Add(new Product() { Id = 29, ProductModel = pantsModel5, ProductStocks = null, Color = "Blue", ImagePath = chinoBluePantsImage, VideoPath = chinoBluePantsVideo }).Entity;
