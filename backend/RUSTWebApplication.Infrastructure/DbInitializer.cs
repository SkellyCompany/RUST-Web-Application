...
namespace RUSTWebApplication.Infrastructure
{
	public class DbInitializer : IDbInitializer
	{
		...
		public void Seed(RUSTWebApplicationContext context)
		{
			...
			ProductModel hoodieModel3 = context.ProductModels.Add(new ProductModel() { Id = 3, Name = "Rape Hoodie", ProductCategory = categoryTop, ProductMetric = metricTop, Price = 69.99, Products = null, ImagePath = oversizedPinkHoodieImage, VideoPath = oversizedPinkHoodieVideo }).Entity;
			...
			ProductModel pantsModel3 = context.ProductModels.Add(new ProductModel() { Id = 8, Name = "Rape Pants", ProductCategory = categoryBottom, ProductMetric = metricBottom, Price = 99.99, Products = null, ImagePath = chinoBrownPantsImage, VideoPath = chinoBrownPantsVideo }).Entity;
